...
?>
    ...
    <div class="full-block-container">
        <div class="half-container bg-cover" style="background-image: url('/assets/img/about-one.jpg');"></div>
    ...
    <div class="full-block-container">
        ...
        <div class="half-container bg-cover" style="background-image: url('/assets/img/about-two.jpg');"></div>
    </div>
    ...
    <div class="value-container">
        ...
        <img src="/assets/img/icons/doted-design.svg" data-aos="fade-left" data-aos-duration="900" data-aos-offset="100" class="doted-img-value" />
    </div>
    ...
    <div class="our-team-container">
        ...
        <div class="team-card-container">
            <div class="each-team-card" data-aos="fade-right" data-aos-duration="800" data-aos-offset="100">
                <div class="doc-profile-image bg-cover" style="background-image: url('/assets/img/footer-doctor.png');"></div>
        ...
        <img src="/assets/img/icons/doted-design.svg" class="doted-img-team" data-aos="fade-up" data-aos-duration="1200" data-aos-offset="100" />
