    ...
    ?>
    <link href="/assets/style/services.css" rel="stylesheet" />
    ...
    <div class="cutom-centered-block services-container">
        ...
        <div class="main-services-container">
            ...
            <div class="service-card">
                <div class="service-img-container">
                    <div class="service-img" style="background-image: url('/assets/img/services/surgery.jpg');"></div>
                </div>
            ...
            <div class="service-card">
                <div class="service-img-container">
                    <div class="service-img" style="background-image: url('/assets/img/services/cath.jpg');"></div>
                </div>
            ...
            <div class="service-card">
                <div class="service-img-container">
                    <div class="service-img" style="background-image: url('/assets/img/services/ante.jpg');"></div>
                </div>
            ...
            <div class="service-card">
                <div class="service-img-container">
                    <div class="service-img" style="background-image: url('/assets/img/services/acg.jpg');"></div>
                </div>
